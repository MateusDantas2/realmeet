...
class RoomValidatorUnitTest extends BaseUnitTeste {
    ...
    void testValidateWhenRoomNameIsMissing() {
        ...
        assertEquals(new ValidationError(ROOM_NAME, ROOM_NAME + MISSING),
    ...
    void testValidateWhenRoomNameExceedsLength() {
        ...
        assertEquals(1, exception.getValidationErrors().getNumberOfErros());
        assertEquals(new ValidationError(ROOM_NAME, ROOM_NAME + EXCEEDS_MAX_LENGTH),
                exception.getValidationErrors().getError(0));
    }
    ...
    void testValidateWhenRoomSeatsAreMissing() {
        ...
        assertEquals(1, exception.getValidationErrors().getNumberOfErros());
        assertEquals(new ValidationError(ROOM_SEATS, ROOM_SEATS + MISSING),
                exception.getValidationErrors().getError(0));
    }
    ...
    void testValidateWhenRoomSeatsAreLessThanMinValue() {
        ...
        assertEquals(1, exception.getValidationErrors().getNumberOfErros());
        assertEquals(new ValidationError(ROOM_SEATS, ROOM_SEATS + BELOW_MIN_VALUE),
                exception.getValidationErrors().getError(0));
    }
    ...
    void testValidateWhenRoomSeatsAreGreaterThanMaxValue() {
        ...
        assertEquals(1, exception.getValidationErrors().getNumberOfErros());
        assertEquals(new ValidationError(ROOM_SEATS, ROOM_SEATS + EXCEEDS_MAX_VALUE),
                exception.getValidationErrors().getError(0));
    }
}
